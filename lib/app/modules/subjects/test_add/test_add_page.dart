          ...
          children: [
            ...
            Expanded(
              child: FutureBuilder<bool?>(
                ...
                future: controller.getQuestionsByTestId(
                ...
                builder: (context, snapshot) {
                  ...
                  final questionsList =
                      controller.testWithQuestions?.questions ?? [];
            ...
            Padding(
              ...
              child: ElevatedButton(
                onPressed:
                    (controller.testWithQuestions?.questions?.isEmpty ?? true)
                    ? null
                    : () {
                        // Saqlash logikasi
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text("Barcha o'zgarishlar saqlandi!"),
                          ),
                        );
                      },
                style: ElevatedButton.styleFrom(
